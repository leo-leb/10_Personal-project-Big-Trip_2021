const createFilterItemTemplate = (filter, currentFilter, emptyList) => {
  ...
  return `<div class="trip-filters__filter">
    <input id="filter-${filter}" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value=${filter} ${filter === currentFilter ? 'checked' : ''} ${checkEmpty === true ? 'disabled' : ''}>
