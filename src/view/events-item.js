import {getFullDate, getShortDate, getFullDateAndTime, getTime, getTimeDuration} from './common';
import {createSelectedOffer} from './offers-selected';
...
export const createEventsItem = (event) => {
  ...
  return `<li class="trip-events__item">
    <div class="event">
      ...
      <ul class="event__selected-offers">${renderList(offers, createSelectedOffer)}</ul>
